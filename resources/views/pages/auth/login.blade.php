...
@section('content')
<div class="lg:p-14 p-8 w-full min-h-screen bg-cover bg-center bg-no-repeat"
    ...
    <div class="flex lg:flex-row flex-col lg:gap-12 gap-8">
        ...
        <div class="w-full">
            ...
            <div class="flex justify-center items-center">
                <img src="{{ asset('assets/icons/login-penghuni-icon.png') }}"
                    alt="Login Penghuni"
                    width="420px"
        ...
        <div class="w-full">
            <div class="flex justify-center lg:pt-10 pt-2">
                <x-card class="w-[500px]">
                    ...
                    <h1 class="lg:text-3xl text-xl text-black font-bold mb-4">
                        Login
                    </h1>
                        ...
                        <div class="flex justify-end">
                            <p>
                                <a href="{{ route('lupa-password') }}"
                                    class="md:text-md text-sm text-[#FE4332] font-medium">
                                    Lupa Password?
                                </a>
                            </p>
                        </div>

                        <x-form.button type="submit" class="my-8">
                            Login
                        </x-form.button>
                    </form>

                    <div class="flex justify-center">
                        <p class="md:text-md text-sm text-[#686868]">
                            Belum punya akun?
