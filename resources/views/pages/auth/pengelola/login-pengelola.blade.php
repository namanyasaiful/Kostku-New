    ...
    <div class="flex lg:flex-row flex-col lg:gap-12 gap-8">
        <div class="w-full">
            ...
            <div class="flex justify-center items-center">
                <img src="{{ asset('assets/icons/login-pengelola-icon.png') }}" alt="Login Pengelola" width="420px" class="lg:block hidden">
            </div>
        </div>
        <div class="w-full">
            <div class="flex justify-center lg:pt-10 pt-2">
                <x-card class="w-[500px]">
                    ...
                    <div class="flex justify-center">
                        <p class="md:text-md text-sm text-[#686868]">Belum punya akun?<span class="text-primary font-semibold"><a href="{{ route('register.pengelola') }}"> Daftar</a></span></p>
                    </div>
                </x-card>
            </div>
        </div>
