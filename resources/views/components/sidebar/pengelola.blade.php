        ...
        <div class="flex flex-col h-auto p-6">
            ...
            <nav class="space-y-2 flex-1">
                ...
                <x-sidebar.item
                    title="Dashboard"
                    icon="dashboard-icon"
                    :route="route('dashboard.pengelola')"
                    :active="request()->routeIs('dashboard.pengelola')" />
                <x-sidebar.item
                    title="Penghuni"
                    icon="penghuni-icon"
                    :route="route('penghuni.pengelola')"
                    :active="request()->routeIs('penghuni.pengelola')" />
                <x-sidebar.item
                    title="Kamar"
                    icon="kamar-icon"
                    :route="route('kamar.pengelola')"
                    :active="request()->routeIs('kamar.pengelola')" />

                <x-sidebar.item
                    title="Pembayaran"
                    icon="pembayaran-icon"
                    :route="route('pembayaran.pengelola')"
                    :active="request()->routeIs('pembayaran.pengelola')" />

                <x-sidebar.item
                    title="Pengaduan"
                    icon="pengaduan-icon"
                    :route="route('pengaduan.pengelola')"
                    :active="request()->routeIs('pengaduan.pengelola')" />
